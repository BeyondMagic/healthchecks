...
class NotifyGotidyTestCase(BaseTestCase):
    ...
    @patch("hc.api.transports.curl.request", autospec=True)
    def test_it_sends_high_priority_for_down(self, mock_post: Mock) -> None:
        mock_post.return_value.status_code = 200
        self.channel.value = json.dumps(
            {
    ...
    @patch("hc.api.transports.curl.request", autospec=True)
    def test_it_sends_high_priority_for_up(self, mock_post: Mock) -> None:
        mock_post.return_value.status_code = 200
    ...
    @patch("hc.api.transports.curl.request", autospec=True)
    def test_it_sends_medium_priority_for_down(self, mock_post: Mock) -> None:
        mock_post.return_value.status_code = 200
        self.channel.value = json.dumps(
            {
                "url": "https://example.org",
    ...
    @patch("hc.api.transports.curl.request", autospec=True)
    def test_it_sends_medium_priority_for_up(self, mock_post: Mock) -> None:
        mock_post.return_value.status_code = 200
        self.flip.new_status = "up"
        self.channel.value = json.dumps(
            {
    ...
    @patch("hc.api.transports.curl.request", autospec=True)
    def test_it_sends_low_priority_for_down(self, mock_post: Mock) -> None:
        mock_post.return_value.status_code = 200
        self.channel.value = json.dumps(
            {
                "url": "https://example.org",
    ...
    @patch("hc.api.transports.curl.request", autospec=True)
    def test_it_sends_low_priority_for_up(self, mock_post: Mock) -> None:
        mock_post.return_value.status_code = 200
        self.flip.new_status = "up"
        self.channel.value = json.dumps(
            {
    ...
    @patch("hc.api.transports.curl.request", autospec=True)
    def test_it_defaults_null_down_priority_to_5(self, mock_post: Mock) -> None:
        mock_post.return_value.status_code = 200
        self.channel.value = json.dumps(
            {
                "url": "https://example.org",
